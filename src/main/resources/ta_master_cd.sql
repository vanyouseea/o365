...
insert into ta_master_cd(key_ty,cd,decode,start_dt,end_dt,create_dt,last_update_id,last_update_dt) values ('GEN_APP_RPT','N','Y to turn on the app overall report @ 06:00 everyday',sysdate,null,sysdate,'o365',sysdate);
