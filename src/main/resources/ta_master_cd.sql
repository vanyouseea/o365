...
insert into ta_master_cd(key_ty,cd,decode,start_dt,end_dt,create_dt,last_update_id,last_update_dt) values ('CREATE_GRP_FOR_USER','Y','Y为当创建用户并分配订阅的同时也尽量创建一个以其为名的私有的SP site给他',sysdate,null,sysdate,'o365',sysdate);
